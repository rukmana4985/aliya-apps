...
public class AdapterVideoHome extends BaseAdapter<ModelVideo> {
    ...
    public AdapterVideoHome(ArrayList<ModelVideo> listItem) {
        super(listItem);
    ...
    protected RecyclerView.ViewHolder createHolder(ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.adapter_list_video_home, parent, false);
        VHVideoHome vhVideoHome = new VHVideoHome(view);
        return vhVideoHome;
    }
...
//        }
        if (holder instanceof VHVideoHome && listItem != null)
            ((VHVideoHome) holder).setData(listItem.get(position));
    }
}
